  ...
  return (
          ...
          </div> 
    {
      data.map(dt => (
        ...
        <input id='updateInput' className = 'w-1/3' value={updateTaskValue} onChange={e => {setUpdateTaskValue(e.target.value)}} type="text" className='text-white border-white border-b-2 border-solid focus:outline-none bg-transparent hidden'/>

  ...
  return (
          ...
          </div> 
    {
      data.map(dt => (
        ...
        <input id='updateInput' value={updateTaskValue} onChange={e => {setUpdateTaskValue(e.target.value)}} type="text" className='w-1/3 text-white border-white border-b-2 border-solid focus:outline-none bg-transparent hidden'/>
